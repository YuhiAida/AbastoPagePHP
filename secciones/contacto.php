		...
		<!--Mapa y informacion de contacto-->
			...
			<section class="contacto">
			      ...
			      <form method="post" action="registro.php" name="contactform" class="contacto-form">
			        <div class="contacto-form-column">
			          ...
			          <input type="checkbox" name="check_list[]" class="contacto-form-checkbox" value="organizacion">
			          Soy una Empresa
			          <input type="checkbox" name="check_list[]" class="contacto-form-checkbox" value="empresa">
			          Otro
